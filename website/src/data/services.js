export const defaultServicesPageData = {
  heroContent: {
    title: 'Our Services',
  ...
  industries: [{
    ...
    title: 'Logistics',
    desc: 'Fleet tracking, route optimization and operations hubs.'
  }, {
    title: 'Real Estate',
    desc: 'Listings, CRMs and virtual tour experiences.'
  }, {
    title: 'Media',
    desc: 'OTT, content pipelines and monetization.'
  }, {
    title: 'Travel',
    desc: 'Search, booking flows and dynamic pricing.'
  }],
  consultationBanner: {
  ...
  packages: [{
    ...
    features: ['Up to 5 pages', 'Responsive design', 'Basic SEO', '3 months support', 'Content management'],
    popular: false
  }, {
    name: 'Professional',
    price: 'Starting at $5,999',
    description: 'Ideal for growing businesses',
    features: ['Up to 15 pages', 'Custom design', 'Advanced SEO', '6 months support', 'E-commerce integration', 'Analytics setup'],
    popular: true
  }, {
    name: 'Enterprise',
    price: 'Custom Pricing',
    description: 'For large organizations',
    features: ['Unlimited pages', 'Custom development', 'Full SEO optimization', '12 months support', 'Advanced integrations', 'Dedicated support'],
    popular: false
  }],
  ctaSection: {
