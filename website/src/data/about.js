export const defaultAboutPageData = {
  ...
  whyChooseUs: ['15+ Years of Combined Experience', '50+ Successful Projects Delivered', '24/7 Customer Support', 'Cutting-edge Technology Stack', 'Agile Development Methodology', 'Competitive Pricing'],
  journeySection: {
    title: 'Our Journey',
  ...
  clientLogos: ['https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+1', 'https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+2', 'https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+3', 'https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+4', 'https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+5', 'https://dummyimage.com/160x60/0b1220/ffffff&text=Brand+6']
};