export const defaultCareerPageData = {
  ...
  checklistSection: {
    ...
    items: ['Exerci laoreet an vix', 'Eum cetero pericula cu', 'Nullam graeco nec ex', 'Dicant molestie eu sed', 'Personal branding is valuable', 'Best possible services', 'Reachable by everyone', 'Growth mindset']
  },
  jobOpeningsSection: {
  ...
  companyCulture: ['Open and transparent communication', 'Flexible work arrangements', 'Regular team building activities', 'Professional development opportunities', 'Innovation and creativity encouraged', 'Diverse and inclusive environment']
};